...
- Prokaryotic proteomes were downloaded from [GTDB](https://gtdb.ecogenomic.org/) (Release 06-RS202)
...
### Retrieve p__Patescibacteria (CPR) HQ genomes

- The genome quality of CPR was estimated by using [custom marker set](https://github.com/Ecogenomics/CheckM/tree/master/custom_marker_sets/) provided by [CheckM](https://github.com/Ecogenomics/CheckM/tree/master)
...
- `interproscan_range_num.R` was updated to `interproscan_assign_domains.R`!
...
- Domain classification
  ...
  - [IPR006668](https://www.ebi.ac.uk/interpro/entry/InterPro/IPR006668/)
    - Magnesium transporter, MgtE intracellular domain (Mg_transptr_MgtE_intracell_dom)
...
|variant      | d__Archaea| d__Bacteria| Total|
|:------------|----------:|-----------:|-----:|
|MgtE         |         82|       19690| 19772|
|MgtE_dN      |         71|         979|  1050|
|MgtE_dCBS    |          0|          11|    11|
...
|MgtE_subtype | d__Archaea| d__Bacteria| Total|
|:------------|----------:|-----------:|-----:|
|TM           |        723|         526|  1249|
|TM_TM        |        241|          65|   306|
